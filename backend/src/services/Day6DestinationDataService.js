...
const RATINGS = {
  ...
  platforms: [
    { name: 'Rayna Tours',  logo: 'https://d2cazmkfw8kdtj.cloudfront.net/assets/Images/AGT-06437/raynatourslogo.png',                                       rating: '4.5', stars: '&#9733;&#9733;&#9733;&#9733;<span style="color:#dddddd">&#9733;</span>', reviews: '3,450 Reviews',  borderColor: '#f0e5c0', bgColor: '#fffdf4', starColor: '#f5a623' },
    { name: 'Trustpilot',   logo: 'https://cdn.trustpilot.net/brand-assets/4.3.0/logo-black.svg',                                                          rating: '4.3', stars: '&#9733;&#9733;&#9733;&#9733;<span style="color:#dddddd">&#9733;</span>', reviews: '52,641 Reviews', borderColor: '#b8e8d0', bgColor: '#f4fcf8', starColor: '#00b67a' },
    { name: 'Tripadvisor',  logo: 'https://static.tacdn.com/img2/brand_refresh/Tripadvisor_lockup_horizontal_secondary_registered.svg',                  rating: '4.6', stars: '&#9733;&#9733;&#9733;&#9733;+',                                            reviews: '12,861 Reviews', borderColor: '#b8e8d0', bgColor: '#f4fcf8', starColor: '#00aa6c' },
    { name: 'Google',       logo: 'https://www.google.com/images/branding/googlelogo/2x/googlelogo_color_272x92dp.png',                                  rating: '4.4', stars: '&#9733;&#9733;&#9733;&#9733;&#9733;',                                    reviews: '1,517 Reviews',  borderColor: '#f5cfc8', bgColor: '#fff8f6', starColor: '#fbbc04' },
  ],
};
